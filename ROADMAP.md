...
Status tracker for every phase and lesson. The status symbols in this file feed the website (`site/build.js` parses them into `site/data.js`), so don't change their shape.

Total estimated duration: ~314 hours. Go at your own pace.
...
| 05 | Chain Rule & Autodiff | ✅ | ~75 min |
| 06 | Probability & Distributions | ✅ | ~45 min |
| 07 | Bayes' Theorem & Statistical Thinking | ✅ | ~75 min |
| 08 | Optimization — The Gradient Descent Family | ✅ | ~75 min |
...
| 17 | Systems of Linear Equations | ✅ | ~75 min |
| 18 | Convex Optimization | ✅ | ~75 min |
| 19 | Complex Numbers for AI | ✅ | ~45 min |
| 20 | Fourier Transform | ✅ | ~75 min |
...
| 08 | Feature Engineering & Feature Selection | ✅ | ~75 min |
| 09 | Model Evaluation — Metrics, Cross-Validation | ✅ | ~75 min |
| 10 | Bias, Variance & Learning Curves | ✅ | ~45 min |
...
| # | Lesson | Status | Est. |
|---|--------|--------|------|
| 01 | The Perceptron — Where It All Began | ✅ | ~45 min |
...
| 05 | Loss Functions — MSE, Cross-Entropy, Contrastive Loss | ✅ | ~45 min |
...
| 09 | Learning Rate Scheduling & Warmup | ✅ | ~45 min |
| 10 | Build Your Own Mini Framework | ✅ | ~120 min |
| 11 | Getting Started with PyTorch | ✅ | ~75 min |
| 12 | Getting Started with JAX | ✅ | ~75 min |
...
| # | Lesson | Status | Est. |
|---|--------|--------|------|
| 01 | Image Basics — Pixels, Channels, Color Spaces | ✅ | ~45 min |
| 02 | Convolution from Scratch | ✅ | ~75 min |
| 03 | CNNs — From LeNet to ResNet | ✅ | ~75 min |
...
| 13 | 3D Vision — Point Clouds, NeRF | ✅ | ~45 min |
| 14 | Vision Transformer (ViT) | ✅ | ~45 min |
| 15 | Real-Time Vision — Edge Deployment | ✅ | ~75 min |
| 16 | Building a Complete Vision Pipeline | ✅ | ~120 min |
...
| 23 | Diffusion Transformers & Rectified Flows | ✅ | ~75 min |
...
| 10 | [The Attention Mechanism — A Breakthrough](phases/05-nlp-foundations-to-advanced/10-attention-mechanism) | ✅ | ~45 min |
...
| 13 | [Question Answering](phases/05-nlp-foundations-to-advanced/13-question-answering) | ✅ | ~75 min |
...
| 17 | [Chatbots — From Rule-Based to Neural](phases/05-nlp-foundations-to-advanced/17-chatbots-rule-to-neural) | ✅ | ~75 min |
...
| 21 | [Natural Language Inference & Textual Entailment](phases/05-nlp-foundations-to-advanced/21-nli-textual-entailment) | ✅ | ~60 min |
...
| 12 | [Building a Voice Assistant Pipeline](phases/06-speech-and-audio/12-voice-assistant-pipeline) | ✅ | ~120 min |
...
| 16 | [Anti-Spoofing & Audio Watermarking](phases/06-speech-and-audio/16-anti-spoofing-audio-watermarking) | ✅ | ~75 min |
...
| # | Lesson | Status | Est. |
|---|--------|--------|------|
| 01 | [Why Transformers — The Problem with RNNs](phases/07-transformers-deep-dive/01-why-transformers) | ✅ | ~45 min |
...
| 09 | [Vision Transformer (ViT)](phases/07-transformers-deep-dive/09-vision-transformers) | ✅ | ~45 min |
...
| 14 | [Build a Transformer from Scratch — Capstone](phases/07-transformers-deep-dive/14-build-a-transformer-capstone) | ✅ | ~120 min |
| 15 | [Attention Variants — Sliding Window, Sparse, Differential](phases/07-transformers-deep-dive/15-attention-variants) | ✅ | ~90 min |
| 16 | [Speculative Decoding — Draft, Verify, Repeat](phases/07-transformers-deep-dive/16-speculative-decoding) | ✅ | ~90 min |
...
| 09 | [Inpainting, Outpainting & Editing](phases/08-generative-ai/09-inpainting-outpainting-editing/) | ✅ | ~75 min |
...
| 10 | Multi-Agent Reinforcement Learning | ✅ | ~45 min |
| 11 | Sim-to-Real Transfer | ✅ | ~45 min |
| 12 | Reinforcement Learning in Games | ✅ | ~75 min |
...
| 03 | [Pre-Training Data Pipelines](phases/10-llms-from-scratch/03-data-pipelines) | ✅ | ~75 min |
...
| 10 | [Evaluation — Benchmarks, Eval, LM Harness](phases/10-llms-from-scratch/10-evaluation) | ✅ | ~75 min |
...
| 15 | [Speculative Decoding & EAGLE-3](phases/10-llms-from-scratch/15-speculative-decoding-eagle3) | ✅ | ~75 min |
...
| 22 | [Async & Hogwild! Inference](phases/10-llms-from-scratch/22-async-hogwild-inference) | ✅ | ~60 min |
| 25 | [Speculative Decoding & EAGLE](phases/10-llms-from-scratch/25-speculative-decoding) | ✅ | ~90 min |
| 34 | [Gradient Checkpointing & Activation Recomputation](phases/10-llms-from-scratch/34-gradient-checkpointing) | ✅ | ~90 min |
...
| 10 | [Evaluating & Testing LLM Applications](phases/11-llm-engineering/10-evaluation) | ✅ | ~45 min |
...
| 13 | [Building a Production-Grade LLM Application](phases/11-llm-engineering/13-production-app) | ✅ | ~120 min |
...
| # | Lesson | Status | Est. |
|---|--------|--------|------|
| 01 | [Vision Transformer & Patch-Token Primitives](phases/12-multimodal-ai/01-vision-transformer-patch-tokens) | ✅ | ~120 min |
| 02 | [CLIP & Contrastive Vision-Language Pre-Training](phases/12-multimodal-ai/02-clip-contrastive-pretraining) | ✅ | ~180 min |
| 03 | [BLIP-2 & Q-Former as a Modality Bridge](phases/12-multimodal-ai/03-blip2-qformer-bridge) | ✅ | ~180 min |
| 04 | [Flamingo & Gated Cross-Attention](phases/12-multimodal-ai/04-flamingo-gated-cross-attention) | ✅ | ~120 min |
| 05 | [LLaVA & Visual Instruction Tuning](phases/12-multimodal-ai/05-llava-visual-instruction-tuning) | ✅ | ~180 min |
| 06 | [Any-Resolution Vision: Patch-n'-Pack & NaFlex](phases/12-multimodal-ai/06-any-resolution-patch-n-pack) | ✅ | ~120 min |
| 07 | [Open-Weight VLM Recipes: What Actually Matters](phases/12-multimodal-ai/07-open-weight-vlm-recipes) | ✅ | ~180 min |
| 08 | [LLaVA-OneVision: Single-Image, Multi-Image, Video](phases/12-multimodal-ai/08-llava-onevision-single-multi-video) | ✅ | ~180 min |
| 09 | [Qwen-VL Family & Dynamic Frame-Rate Video](phases/12-multimodal-ai/09-qwen-vl-family-dynamic-fps) | ✅ | ~120 min |
| 10 | [InternVL3 Native Multimodal Pre-Training](phases/12-multimodal-ai/10-internvl3-native-multimodal) | ✅ | ~120 min |
| 11 | [Chameleon & Early-Fusion Pure Tokens](phases/12-multimodal-ai/11-chameleon-early-fusion-tokens) | ✅ | ~180 min |
...
| 14 | [Show-o & Discrete Diffusion Unified](phases/12-multimodal-ai/14-show-o-discrete-diffusion-unified) | ✅ | ~120 min |
...
| 19 | [Audio-Language Models: From Whisper to AF3](phases/12-multimodal-ai/19-audio-language-whisper-to-af3) | ✅ | ~180 min |
...
| 22 | [Document & Diagram Understanding](phases/12-multimodal-ai/22-document-diagram-understanding) | ✅ | ~180 min |
| 23 | [ColPali Vision-Native Document RAG](phases/12-multimodal-ai/23-colpali-vision-native-rag) | ✅ | ~180 min |
| 24 | [Multimodal RAG & Cross-Modal Retrieval](phases/12-multimodal-ai/24-multimodal-rag-cross-modal) | ✅ | ~180 min |
| 25 | [Multimodal Agents & Computer Use (Capstone)](phases/12-multimodal-ai/25-multimodal-agents-computer-use) | ✅ | ~240 min |
...
| 03 | [Parallel & Streaming Tool Calls](phases/13-tools-and-protocols/03-parallel-and-streaming-tool-calls/) | ✅ | ~75 min |
...
| 10 | [MCP Resources & Prompts](phases/13-tools-and-protocols/10-mcp-resources-and-prompts/) | ✅ | ~45 min |
| 11 | [MCP Sampling](phases/13-tools-and-protocols/11-mcp-sampling/) | ✅ | ~75 min |
| 12 | [MCP Roots & Elicitation](phases/13-tools-and-protocols/12-mcp-roots-and-elicitation/) | ✅ | ~45 min |
...
| 17 | [MCP Gateways & Registries](phases/13-tools-and-protocols/17-mcp-gateways-and-registries/) | ✅ | ~45 min |
...
| 22 | [Skills & Agent SDKs](phases/13-tools-and-protocols/22-skills-and-agent-sdks/) | ✅ | ~45 min |
...
| 02 | ReWOO & Plan-Execute | ✅ | ~60 min |
| 03 | Reflexion & Verbal Reinforcement Learning | ✅ | ~60 min |
| 04 | Tree-of-Thought & LATS | ✅ | ~75 min |
| 05 | Self-Refine & CRITIC | ✅ | ~60 min |
| 06 | Tool Use & Function Calling | ✅ | ~60 min |
| 07 | Memory — Virtual Context & MemGPT | ✅ | ~75 min |
| 08 | Memory Blocks & Sleep-Time Compute (Letta) | ✅ | ~75 min |
| 09 | Hybrid Memory — Vector + Graph + KV (Mem0) | ✅ | ~75 min |
| 10 | Skill Library & Lifelong Learning (Voyager) | ✅ | ~75 min |
| 11 | Planning with HTN & Evolutionary Search | ✅ | ~75 min |
| 12 | Anthropic's Workflow Patterns | ✅ | ~60 min |
| 13 | LangGraph — Stateful Graphs & Persistent Execution | ✅ | ~75 min |
| 14 | AutoGen v0.4 — The Actor Model | ✅ | ~75 min |
| 15 | CrewAI — Role-Based Teams & Processes | ✅ | ~60 min |
| 16 | OpenAI Agents SDK — Handoffs, Guardrails, Tracing | ✅ | ~75 min |
| 17 | Claude Agent SDK — Sub-Agents & Conversation Store | ✅ | ~75 min |
| 18 | Agno & Mastra — Production-Grade Runtimes | ✅ | ~45 min |
| 19 | Benchmarks — SWE-bench, GAIA, AgentBench | ✅ | ~60 min |
| 20 | Benchmarks — WebArena & OSWorld | ✅ | ~60 min |
| 21 | Computer Use — Claude, OpenAI CUA, Gemini | ✅ | ~60 min |
| 22 | Voice Agents — Pipecat & LiveKit | ✅ | ~60 min |
| 23 | OpenTelemetry GenAI Semantic Conventions | ✅ | ~60 min |
| 24 | Agent Observability — Langfuse, Phoenix, Opik | ✅ | ~45 min |
| 25 | Multi-Agent Debate & Collaboration | ✅ | ~60 min |
| 26 | Failure Modes — Why Agents Crash | ✅ | ~60 min |
| 27 | Prompt Injection & PVE Defenses | ✅ | ~75 min |
| 28 | Orchestration Patterns — Supervisor, Swarm, Hierarchical | ✅ | ~60 min |
| 29 | Production Runtimes — Queues, Events, Cron | ✅ | ~60 min |
| 30 | Eval-Driven Agent Development | ✅ | ~60 min |
| 31 | The Agent Workbench: Why Capable Models Still Fail | ✅ | ~45 min |
| 32 | Minimal Agent Workbench | ✅ | ~45 min |
| 33 | Writing Agent Instructions as Executable Constraints | ✅ | ~50 min |
| 34 | Repository Memory & Persistent State | ✅ | ~60 min |
| 35 | Agent Init Scripts | ✅ | ~45 min |
| 36 | Scope Contracts & Task Boundaries | ✅ | ~50 min |
| 37 | Runtime Feedback Loops | ✅ | ~50 min |
| 38 | Verification Gates | ✅ | ~55 min |
| 39 | Review Agents: Separating Builder from Scorer | ✅ | ~55 min |
| 40 | Multi-Session Handoffs | ✅ | ~50 min |
| 41 | Running the Workbench on a Real Repository | ✅ | ~60 min |
| 42 | Capstone: Shipping a Reusable Agent Workbench Package | ✅ | ~75 min |
...
| 03 | AlphaEvolve — Evolutionary Coding Agent | ✅ | ~60 min |
| 04 | Darwin Gödel Machine — Self-Modifying Agent | ✅ | ~60 min |
...
| 08 | Bounded Self-Improvement Design | ✅ | ~60 min |
| 09 | Autonomous Coding Agents Overview (SWE-bench, CodeAct) | ✅ | ~45 min |
| 10 | Claude Code Permission Modes & Auto Mode | ✅ | ~45 min |
| 11 | Browser Agents & Indirect Prompt Injection | ✅ | ~45 min |
| 12 | Persistent Execution for Long-Running Agents | ✅ | ~60 min |
...
| 16 | Checkpoints & Rollback | ✅ | ~60 min |
| 17 | Constitutional AI & Rule Override | ✅ | ~60 min |
| 18 | Llama Guard & Input/Output Classification | ✅ | ~45 min |
| 19 | Anthropic Responsible Scaling Policy v3.0 | ✅ | ~45 min |
| 20 | OpenAI Preparedness Framework & DeepMind FSF | ✅ | ~45 min |
| 21 | METR Time Horizons & External Evaluations | ✅ | ~60 min |
| 22 | CAIS, CAISI & Societal-Scale Risk | ✅ | ~45 min |
...
| 02 | [FIPA-ACL Heritage & Speech Acts](phases/16-multi-agent-and-swarms/02-fipa-acl-heritage/) | ✅ | ~60 min |
| 03 | [Communication Protocols](phases/16-multi-agent-and-swarms/03-communication-protocols/) | ✅ | ~45 min |
| 04 | [Multi-Agent Primitives Model](phases/16-multi-agent-and-swarms/04-primitive-model/) | ✅ | ~60 min |
| 05 | [Supervisor / Orchestrator-Worker Pattern](phases/16-multi-agent-and-swarms/05-supervisor-orchestrator-pattern/) | ✅ | ~75 min |
| 06 | [Hierarchical Architecture & Decomposition Drift](phases/16-multi-agent-and-swarms/06-hierarchical-architecture/) | ✅ | ~60 min |
| 07 | [Society of Mind & Multi-Agent Debate](phases/16-multi-agent-and-swarms/07-society-of-mind-debate/) | ✅ | ~75 min |
| 08 | [Role Specialization — Planner / Critic / Executor / Verifier](phases/16-multi-agent-and-swarms/08-role-specialization/) | ✅ | ~75 min |
| 09 | [Parallel Swarms & Networked Architectures](phases/16-multi-agent-and-swarms/09-parallel-swarm-networks/) | ✅ | ~60 min |
| 10 | [Group Chat & Speaker Selection](phases/16-multi-agent-and-swarms/10-group-chat-speaker-selection/) | ✅ | ~60 min |
| 11 | [Handoffs & Routines (Stateless Orchestration)](phases/16-multi-agent-and-swarms/11-handoffs-and-routines/) | ✅ | ~60 min |
| 12 | [A2A — Agent-to-Agent Protocol](phases/16-multi-agent-and-swarms/12-a2a-protocol/) | ✅ | ~75 min |
| 13 | [Shared Memory & Blackboard Pattern](phases/16-multi-agent-and-swarms/13-shared-memory-blackboard/) | ✅ | ~75 min |
| 14 | [Consensus & Byzantine Fault Tolerance for Agents](phases/16-multi-agent-and-swarms/14-consensus-and-bft/) | ✅ | ~75 min |
| 15 | [Voting, Self-Consistency & Debate Topologies](phases/16-multi-agent-and-swarms/15-voting-debate-topology/) | ✅ | ~75 min |
| 16 | [Negotiation & Bargaining](phases/16-multi-agent-and-swarms/16-negotiation-bargaining/) | ✅ | ~75 min |
| 17 | [Generative Agents & Emergent Simulation](phases/16-multi-agent-and-swarms/17-generative-agents-simulation/) | ✅ | ~75 min |
| 18 | [Theory of Mind & Emergent Coordination](phases/16-multi-agent-and-swarms/18-theory-of-mind-coordination/) | ✅ | ~75 min |
...
| 22 | [Production Scaling — Queues, Checkpoints, Persistence](phases/16-multi-agent-and-swarms/22-production-scaling-queues-checkpoints/) | ✅ | ~75 min |
| 23 | [Failure Modes — MAST, Groupthink, Monoculture, Cascades](phases/16-multi-agent-and-swarms/23-failure-modes-mast-groupthink/) | ✅ | ~75 min |
| 24 | [Evaluation & Coordination Benchmarks](phases/16-multi-agent-and-swarms/24-evaluation-coordination-benchmarks/) | ✅ | ~75 min |
| 25 | [Case Studies & 2026 State of the Art](phases/16-multi-agent-and-swarms/25-case-studies-2026-sota/) | ✅ | ~90 min |
...
| 03 | GPU Auto-Scaling on Kubernetes — Karpenter, KAI Scheduler | ✅ | ~75 min |
...
| 06 | SGLang & RadixAttention for Prefix-Heavy Workloads | ✅ | ~60 min |
| 07 | TensorRT-LLM with FP8 & NVFP4 on Blackwell | ✅ | ~75 min |
...
| 11 | Multi-Region LLM Serving & KV Cache Locality | ✅ | ~60 min |
| 12 | Edge Inference — ANE, Hexagon, WebGPU, Jetson | ✅ | ~60 min |
| 13 | LLM Observability Stack Selection | ✅ | ~60 min |
| 14 | Economics of Prompt Caching & Semantic Caching | ✅ | ~60 min |
| 15 | Batch APIs — 50% Discount as Industry Standard | ✅ | ~45 min |
| 16 | Model Routing as a Cost-Reduction Primitive | ✅ | ~60 min |
| 17 | Prefill/Decode Disaggregation — NVIDIA Dynamo & llm-d | ✅ | ~75 min |
| 18 | vLLM Production Stack with LMCache KV Offload | ✅ | ~60 min |
| 19 | AI Gateways — LiteLLM, Portkey, Kong, Bifrost | ✅ | ~60 min |
| 20 | Shadow, Canary & Progressive Deployments | ✅ | ~60 min |
| 21 | A/B Testing LLM Features — GrowthBook & Statsig | ✅ | ~60 min |
...
| 25 | Security — Secrets, PII Redaction, Audit Logs | ✅ | ~60 min |
| 26 | Compliance — SOC 2, HIPAA, GDPR, EU AI Act, ISO 42001 | ✅ | ~60 min |
| 27 | FinOps for LLMs — Unit Economics & Multi-Tenant Attribution | ✅ | ~60 min |
| 28 | Self-Hosted Serving Options — llama.cpp, Ollama, TGI, vLLM, SGLang | ✅ | ~45 min |

## Phase 18: Ethics, Safety & Alignment — ✅ (~31 hours)

| # | Lesson | Status | Est. |
|---|--------|--------|------|
| 01 | [Instruction Following as an Alignment Signal](phases/18-ethics-safety-alignment/01-instruction-following-alignment-signal) | ✅ | ~45 min |
| 02 | [Reward Hacking & Goodhart's Law](phases/18-ethics-safety-alignment/02-reward-hacking-goodhart) | ✅ | ~60 min |
| 03 | [The Direct Preference Optimization Family](phases/18-ethics-safety-alignment/03-direct-preference-optimization-family) | ✅ | ~60 min |
...
| 10 | [AI Control — Safety Under Subversion](phases/18-ethics-safety-alignment/10-ai-control-subversion) | ✅ | ~75 min |
...
| 16 | [Red Teaming Tools — Garak, Llama Guard, CyberSecEval](phases/18-ethics-safety-alignment/16-red-teaming-tools-garak-llamaguard) | ✅ | ~60 min |
...
| 26 | [Model Cards, System Cards & Dataset Cards](phases/18-ethics-safety-alignment/26-model-system-dataset-cards) | ✅ | ~60 min |
...
## Phase 19: Capstone Projects — ✅ (~800 hours)
...
| 05 | [Autonomous Research Agent (AI-Scientist Level)](phases/19-capstone-projects/05-autonomous-research-agent) | ✅ | ~40 hr |
...
| 11 | [LLM Observability & Evaluation Dashboard](phases/19-capstone-projects/11-llm-observability-dashboard) | ✅ | ~25 hr |
| 12 | [Video Understanding Pipeline (Scene to QA)](phases/19-capstone-projects/12-video-understanding-pipeline) | ✅ | ~30 hr |
| 13 | [MCP Server with Registry & Governance](phases/19-capstone-projects/13-mcp-server-with-registry) | ✅ | ~25 hr |
...
| 25 | [Verification Gates & Observation Budget](phases/19-capstone-projects/25-verification-gates-observation-budget) | ✅ | ~90 min |
| 26 | [Sandbox Runner with Denylist & Path Jail](phases/19-capstone-projects/26-sandbox-runner-denylist) | ✅ | ~90 min |
| 27 | [Eval Harness with Fixture Tasks](phases/19-capstone-projects/27-eval-harness-fixture-tasks) | ✅ | ~90 min |
| 28 | [Observability with OTel GenAI Spans & Prometheus](phases/19-capstone-projects/28-observability-otel-traces) | ✅ | ~90 min |
| 29 | [End-to-End Coding Agent Demo](phases/19-capstone-projects/29-end-to-end-coding-task-demo) | ✅ | ~90 min |
...
| 32 | [Token Embedding & Positional Embedding](phases/19-capstone-projects/32-token-positional-embeddings) | ✅ | ~90 min |
...
| 36 | [Training Loop & Evaluation](phases/19-capstone-projects/36-training-loop-eval) | ✅ | ~90 min |
| 37 | [Loading Pre-Trained Weights](phases/19-capstone-projects/37-loading-pretrained-weights) | ✅ | ~90 min |
| 38 | [Classifier Fine-Tuning via Head Swap](phases/19-capstone-projects/38-classifier-finetuning) | ✅ | ~90 min |
| 39 | [Instruction Tuning via SFT](phases/19-capstone-projects/39-instruction-tuning-sft) | ✅ | ~90 min |
| 40 | [DPO from Scratch](phases/19-capstone-projects/40-dpo-from-scratch) | ✅ | ~90 min |
| 41 | [Complete Evaluation Pipeline](phases/19-capstone-projects/41-eval-pipeline) | ✅ | ~90 min |
| 42 | [Large-Scale Corpus Downloader](phases/19-capstone-projects/42-large-corpus-downloader) | ✅ | ~90 min |
| 43 | [HDF5 Tokenized Corpus](phases/19-capstone-projects/43-hdf5-tokenized-corpus) | ✅ | ~90 min |
| 44 | [Cosine Learning Rate + Linear Warmup](phases/19-capstone-projects/44-cosine-lr-warmup) | ✅ | ~90 min |
| 45 | [Gradient Clipping & Mixed-Precision Training](phases/19-capstone-projects/45-gradient-clipping-amp) | ✅ | ~90 min |
| 46 | [Gradient Accumulation](phases/19-capstone-projects/46-gradient-accumulation) | ✅ | ~90 min |
| 47 | [Checkpoint Save & Resume](phases/19-capstone-projects/47-checkpoint-save-resume) | ✅ | ~90 min |
| 48 | [Distributed Data Parallel & FSDP from Scratch](phases/19-capstone-projects/48-distributed-fsdp-ddp) | ✅ | ~90 min |
| 49 | [Language Model Evaluation Framework](phases/19-capstone-projects/49-lm-eval-harness) | ✅ | ~90 min |
...
| 58 | [Vision Encoder Patch Splitting](phases/19-capstone-projects/58-vision-encoder-patches) | ✅ | ~90 min |
| 59 | [Vision Transformer Encoder (ViT)](phases/19-capstone-projects/59-vit-transformer) | ✅ | ~90 min |
| 60 | [Modality Alignment via Projection Layer](phases/19-capstone-projects/60-projection-layer-modality-align) | ✅ | ~90 min |
| 61 | [Cross-Attention Fusion](phases/19-capstone-projects/61-cross-attention-fusion) | ✅ | ~90 min |
| 62 | [Vision-Language Pre-Training](phases/19-capstone-projects/62-vision-language-pretraining) | ✅ | ~90 min |
| 63 | [Multimodal Evaluation](phases/19-capstone-projects/63-multimodal-eval) | ✅ | ~90 min |
| 64 | [Chunking Strategies Comparison](phases/19-capstone-projects/64-chunking-strategies-advanced) | ✅ | ~90 min |
| 65 | [Hybrid Retrieval with BM25 & Dense Embedding](phases/19-capstone-projects/65-hybrid-retrieval-bm25-dense) | ✅ | ~90 min |
| 66 | [Cross-Encoder Reranker](phases/19-capstone-projects/66-reranker-cross-encoder) | ✅ | ~90 min |
| 67 | [Query Rewriting: HyDE, Multi-Query & Decomposition](phases/19-capstone-projects/67-query-rewriting-hyde) | ✅ | ~90 min |
| 68 | [RAG Evaluation: Precision, Recall, MRR, nDCG](phases/19-capstone-projects/68-rag-eval-precision-recall) | ✅ | ~90 min |
...
| 71 | [Classical Evaluation Metrics](phases/19-capstone-projects/71-classical-metrics) | ✅ | ~90 min |
| 72 | [Code Execution Metrics](phases/19-capstone-projects/72-code-exec-metric) | ✅ | ~90 min |
| 73 | [Perplexity & Calibration](phases/19-capstone-projects/73-perplexity-calibration) | ✅ | ~90 min |
...
| 76 | [Collective Communication from Scratch](phases/19-capstone-projects/76-collective-ops-from-scratch) | ✅ | ~90 min |
| 77 | [Data Parallel DDP](phases/19-capstone-projects/77-data-parallel-ddp) | ✅ | ~90 min |
| 78 | [ZeRO Optimizer State Sharding](phases/19-capstone-projects/78-zero-parameter-sharding) | ✅ | ~90 min |
| 79 | [Pipeline Parallel & Bubble Analysis](phases/19-capstone-projects/79-pipeline-parallel) | ✅ | ~90 min |
| 80 | [Sharded Checkpoint & Atomic Resume](phases/19-capstone-projects/80-checkpoint-sharded-resume) | ✅ | ~90 min |
...
**Total: 20 phases, 503 lessons | 503 completed | ~1100 hours estimated**

Want to contribute? Pick any ⬚ lesson and submit a PR. See [CONTRIBUTING.md](CONTRIBUTING.md) for details.
